$(document).ready(function () {
	...
	["併用", "へいよう👉一緒に使う。", "～する＝တပြိုင်နက်တည်းသုံးသည်။ ပေါင်းစပ်အသုံးပြုသည်။", "Eng: use at the same time/ combination/ concomitant use"],
	...
	["独占", "どくせん👉独り占めること。", "လက်ဝါးကြီးအုပ်ခြင်း။", "Eng: monopoly"],
	["公正", "みうち👉かたよりがなく正当なこと。", "～な＝ဘက်မလိုက်သော။ မျှတသော။", "Eng: fair"],
	["妨げる", "さまたげる👉じゃまする。", "အဟန့်အတားဖြစ်သည်။ အနှောင့်အယှက်ဖြစ်သည်။", "Eng: hinder/ interfere/ disturb/ obtruct"],
	["妨害", "ぼうがい👉じゃますること。", "အနှောင့်အယှက်။ အဟန့်အတား။", "Eng: hindrance/ interference/ disturbance/ obstruction"],
	["対価", "たいか👉商品やサービスを提供する際に受け取る報酬や品物のこと。", "(ထိုက်သင့်သော) အဖိုးအခ။", "Eng: consideration"],
	["初期", "しょき👉初めの時期。", "ကနဦး။ အစပိုင်း။", "Eng: initial/ inital stage"]];
